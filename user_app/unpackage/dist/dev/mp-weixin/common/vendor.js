...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__EBFC593",
    appName: "user_app",
    appVersion: "1.0.0",
    appVersionCode: "100",
    appLanguage: getAppLanguage(hostLanguage),
    uniCompileVersion: "4.03",
    uniRuntimeVersion: "4.03",
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "注册车辆信息",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/regist/components/regist-userinfo",
    style: {}
  }
];
const globalStyle = {
