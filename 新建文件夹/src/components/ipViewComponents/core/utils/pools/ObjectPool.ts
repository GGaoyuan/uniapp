 ...
 */
 class ObjectPool{
     ...
     */
    public clearClass(ref:any, clearFuncName:string = null):void{
        var list:Array<any> = ObjectPool._content[ref];
     ...
     */
    public dealFunc(ref:any, dealFuncName:string):void{
        var list:Array<any> = ObjectPool._content[ref];
        if(list == null){
            return;
        }
...
export var objectPool = new ObjectPool();