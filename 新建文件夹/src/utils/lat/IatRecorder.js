...
import { TranscodeWorker } from "./TranscodeWorker.ts";


const APPID = "7de7bae7";
const API_SECRET = "NjU4NDM5MmFjM2ZmYTg1OGZkMjE4NjUy";
const API_KEY = "89ee62effc1d3ec5eddc5fceb4a765f2";


const transWorker = new TranscodeWorker();
...
const IatRecorder = class {
  ...
  recorderInit() {
    ...
    } else if (uni.getRecorderManager) {
